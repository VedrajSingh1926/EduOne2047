...
const filePath = 'c:/Users/vedra/OneDrive/Documents/My Projects/EduOne2047/EduOne-2047/src/components/dashboard/OperationsDashboard.tsx';
...
const metricCardsRegex = /\{\/\* Metric Cards - Minimal White Cards \*\/\}[\s\S]*?(?=\{\/\* Personalized Workspace Snapshot \*\/\}|<!-- end Metric Cards -->)/;

const metricCardsReplacement = `{/* Metric Cards - Dynamic by Role */}
...
content = content.replace(metricCardsRegex, metricCardsReplacement);

      ...
      <div className="premium-container flex flex-col md:flex-row items-center justify-between gap-3">
        ...
        <div className="flex items-center justify-end gap-2 w-full md:w-auto">
          ...
          <button
            ...
            className={`hidden xl:flex px-2.5 py-1.5 text-xs font-bold rounded-xl border transition-all items-center gap-1.5 shadow-2xs ${
              easyMode
          ...
          <button
            ...
            className="hidden lg:block p-2 rounded-xl bg-slate-100 hover:bg-emerald-100 border border-slate-300 text-emerald-700 transition-colors"
          ...
          <button
            ...
            className="hidden lg:block p-2 rounded-xl bg-slate-100 hover:bg-slate-200 border border-slate-300 text-slate-700 transition-colors"
          ...
          {onOpenShortcuts && (
            <button
              ...
              className="hidden xl:flex px-2.5 py-1.5 rounded-xl bg-slate-100 hover:bg-slate-200 border border-slate-300 text-slate-800 font-bold text-xs items-center gap-1.5 shadow-2xs"

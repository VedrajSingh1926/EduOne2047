            ...
            <div className="pt-2 border-t border-slate-100 flex items-center justify-between gap-2">
              ...
              {teacher.status !== 'PRESENT' && (
                <button
                  ...
                  className="px-3 py-1 rounded-lg bg-blue-600 text-white text-xs font-medium hover:bg-blue-700 transition-all flex items-center gap-1 shadow-2xs"
                >
          ...
          <div className="bg-white rounded-2xl max-w-lg w-full p-6 border border-slate-200 shadow-xl relative space-y-4">
            ...
            <div className="pt-2 flex justify-end gap-2">
              ...
              <button
                ...
                className="px-4 py-1.5 rounded-lg bg-blue-600 text-white font-medium text-xs hover:bg-blue-700 disabled:opacity-50"
              >
                Assign Substitute
              </button>
            </div>

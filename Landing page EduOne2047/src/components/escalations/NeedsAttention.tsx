...
export const NeedsAttention: React.FC<NeedsAttentionProps> = ({
  ...
  const getSeverityBadge = (severity: Severity) => {
    switch (severity) {
      ...
      case 'HIGH':
        return <span className="px-2 py-0.5 text-[10px] font-semibold rounded bg-amber-50 text-amber-700 border border-amber-200">High</span>;
      case 'MEDIUM':
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs">
                ...
                <div className="p-3.5 rounded-xl bg-blue-50/40 border border-blue-100 space-y-1">
                  ...
                  {item.requiresApproval && (
                    <div className="text-[10px] font-medium text-amber-700 pt-1 flex items-center gap-1">

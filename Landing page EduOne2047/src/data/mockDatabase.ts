...
export const INITIAL_USERS: UserAccount[] = [
  {
    ...
    department: 'Staff Credentials & System Access',
    email: 'sarah.connor@eduone2047.org',
  ...
  },
  {
    ...
    email: 'evelyn.vance@eduone2047.org',
  ...
  },
  {
    ...
    role: 'Vice Principal',
    passwordHash: 'pass123',
    department: 'Academic Operations & Discipline',
    email: 'marcus.sterling@eduone2047.org',
    phone: '+1 (555) 014-9876',
    status: 'ACTIVE',
    dateIssued: '2026-01-05',
    lastLogin: 'Today, 07:50 AM',
    issuedBy: 'Sarah Connor (ID Admin)'
  },
  {
    id: 'USR-004',
    userId: 'ADM-2047',
    ...
    role: 'Admin',
    passwordHash: 'pass123',
    department: 'System Operations & Logistics',
    email: 'arthur.p@eduone2047.org',
  ...
  },
  {
    ...
    email: 'elena.rostova@eduone2047.org',
  ...
  },
  {
    ...
    email: 'david.miller@eduone2047.org',
  ...
  },
  {
    ...
    email: 'robert.chen@eduone2047.org',
...
export const INITIAL_ID_AUDIT_LOGS: IDAuditLog[] = [
  {
    id: 'AUD-001',
    targetUserId: 'TCH-102',
    targetName: 'David Miller',
    action: 'RESET_PASSWORD',
    performedBy: 'Sarah Connor (ID Admin)',
    timestamp: '2026-07-27 14:20',
    details: 'Issued temporary password pass123 following verbal credential reset request.'
  },
  {
    id: 'AUD-002',
    targetUserId: 'STF-201',
    targetName: 'Robert Chen',
    action: 'CREATED_ID',
    performedBy: 'Sarah Connor (ID Admin)',
    timestamp: '2026-07-25 09:15',
    details: 'Created new staff ID STF-201 for Facilities Department.'
  },
  {
    id: 'AUD-003',
    targetUserId: 'VP-2047',
    targetName: 'Marcus Sterling',
    action: 'UPDATED_ROLE',
    performedBy: 'Sarah Connor (ID Admin)',
    timestamp: '2026-07-20 11:00',
    details: 'Elevated system scope for Vice Principal office & academic overrides.'
  }
];
